...
Open the `.circ` file using Logisim Evolution to inspect, run, and test the circuit.

Screenshots of the simulation are stored separately in the `images/Logisim/` folder.
